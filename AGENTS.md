...
→ `docs/learning/ibm_pa.md` — IBM PA REST API
→ `docs/learning/concepts.md` — stack Python/FastAPI/SQLAlchemy
→ `docs/learning/claude_code_concepts.md` — Claude Code, commandes, comportements
→ `docs/context/claude-desktop/CONTEXT_FOR_CLAUDE_AI.md` — contexte pour l'assistant pédagogique Claude AI
